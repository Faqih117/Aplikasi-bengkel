...
Adodc1.Recordset!Kode_customer = Text1.Text
Adodc1.Recordset!Nama_customer = Text2.Text
Adodc1.Recordset!alamat = Text3.Text
Adodc1.Recordset!telepon = Text5.Text
Adodc1.Recordset!No_plat = Text6.Text
...
Call BukaDB
        RSCustomer.Open "Select * from Customer ", Koneksi
Text1.Text = Adodc1.Recordset!Kode_customer
Text2.Text = Adodc1.Recordset!Nama_customer
Text3.Text = Adodc1.Recordset!alamat
Text5.Text = Adodc1.Recordset!telepon
Text6.Text = Adodc1.Recordset!No_plat
Adodc1.Recordset.Update
End Sub
Private Sub Command2_Click()
    If Text1 = "" Or Text2 = "" Or Text3 = "" Or Text5.Text = "" Or Text6.Text = "" Then
...
!Kode_customer = Text1.Text
!Nama_customer = Text2.Text
!alamat = Text3.Text
!telepon = Text5.Text
!No_plat = Text6.Text
.Update
...
Sub autokode()
Call BukaDB
RSCustomer.Open ("select * from Customer Where Kode_customer in(select max(Kode_customer)from Customer)order by Kode_customer Desc"), Koneksi
RSCustomer.Requery
    ...
    With Barang
        If RSCustomer.EOF Then
            ...
            Text1.Text = Urutan
        Else
            Hitung = Right(RSCustomer!Kode_customer, 4) + 1
            Urutan = "CSS" + Right("0000" & Hitung, 4)
        End If
        Text1.Text = Urutan
    End With
End Sub
...
RSCustomer.Open "select * from Customer where Kode_customer like '%" & Text4.Text & "%' or Nama_customer like '%" & Text4.Text & "%'", Koneksi
    With RSCustomer
        If Not (.BOF And .EOF) Then
            mvBookmark = .Bookmark
        End If
    End With
Set DataGrid1.DataSource = RSCustomer.DataSource
DataGrid1.Refresh
End Sub
